...
(function() {
  var color, div, h, hicolor, labels, links, pad, rect, svgs, text, toth, totw, urls, w;
  ...
  text = svgs.append("text").text(function(lab) {
    return lab;
  }).attr("x", pad + w / 2).attr("y", pad + h / 2).style("dominant-baseline", "middle").style("text-anchor", "middle").style("pointer-events", "none").attr("fill", "white").style("font-size", "24px");
